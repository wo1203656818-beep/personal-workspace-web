  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border bg-card p-3">
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate text-sm font-medium">决策倒计时</p>
        <p className="truncate text-xs text-muted-foreground">时间到后必须做出选择，不再纠结</p>
      </div>
      <div className={`shrink-0 text-2xl font-mono font-bold ${color}`}>
