...
export function TaskSubtasks({
  ...
  addSubtaskMutation: UseMutationResult<Subtask, Error, { title: string; sortOrder?: number }, unknown>
  ...
  reorderSubtaskMutation: UseMutationResult<unknown, Error, { id: string; sortOrder: number }[], unknown>
}) {
  return (
          ...
          <React.Fragment key={st.id}>
            <div className="flex justify-center">
              {insertAtPosition === st.sortOrder + 0.5 ? (
                <div className="flex w-full items-center gap-2 px-2 py-1">
                  ...
                  <Input
                    ...
                    onKeyDown={(e) => {
                      ...
                      if (e.key === 'Escape') { onInsertAtPositionChange(null); onNewSubtaskChange('') }
                    }}
                    onBlur={() => { onInsertAtPositionChange(null); onNewSubtaskChange('') }}
                    placeholder="输入子步骤..."
                ...
                <button
                  type="button"
                  onClick={() => { onInsertAtPositionChange(st.sortOrder + 0.5); onNewSubtaskChange('') }}
