...
import { Loader2, Trophy, TrendingUp, History, Sparkles, RotateCcw } from 'lucide-react'
import {
    ...
    <div className="flex h-full flex-col">
      <div className="flex items-center justify-between border-b bg-card/50 px-4 py-4 backdrop-blur-sm md:px-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold tracking-tight md:text-2xl">天意硬币</h1>
            <p className="mt-0.5 text-xs text-muted-foreground md:text-sm">基于物理熵的真随机决策</p>
          </div>
        </div>
      </div>
